...
export function Navbar() {
    ...
    const navBtnStyle = `text-lg px-3 py-2 md:p-1 bg-background hover:bg-purple hover:border-background hover:text-black  font-mono transition duration-300 bg-background, md:px-2 border-2 border-purple rounded-md p-1 w-[85%] md:w-[100%] text-purple`
    ...
    return (
        ...
        <nav className="bg-transparent backdrop-blur-md md:backdrop-blur-0 md:bg-background  flex justify-center items-center fixed w-full z-50 top-0 start-0 shadow-xl">
