...
// Doing it this way because in order for refs to be accessible, the component needs to be mounted
    ...
    return (
        ...
        <animated.nav style={enterLeft} className="bg-transparent backdrop-blur-md md:backdrop-blur-0 md:bg-background flex justify-center items-center fixed w-full lg:mb-[50px] z-50 top-0 start-0 shadow-xl">
