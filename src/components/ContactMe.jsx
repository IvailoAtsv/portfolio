        ...
        <div id='contact' ref={componentRef} className="h-auto relative flex flex-col justify-center items-center w-full">
            ...
            <div className="max-w-[1800px] min-h-[90vh] lg:min-h-[45vh] py-4 relative w-[90%] justify-between flex flex-col lg:flex-row items-start">
                ...
                ? (<div className="flex-2 w-full flex p-4 flex-col lg:max-w-[42%] justify-center items-start rounded-xl">
                  {loading? <h2 className='text-4xl text-white font-semibold animate-pulse'>Loading...</h2> :<h2 className='text-4xl text-white font-semibold'>Thanks for contacting me <FaHeart className='inline'/><br/>I'll do my best to reply soon </h2>}
                </div>)
                ...
                {errors.message ?
                    ...
                    <button type="submit" disabled={sent} className={`${buttonStyle} my-2`}>Let's have a chat!</button>
                </animated.form>}
